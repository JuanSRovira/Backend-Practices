...
exports.seed = async function (knex) {
  ...
  // PLANTILLA DE CREACION DE TABLAS
  // await knex('table_name').del() Si se corre esto solo borra los registros, se recomienda usar
  // await knex('table_name').truncate() Esto ademas RESETEA el nombre del ID
  // cambie el nombre de table_name a homes, pues es el nombre de mi talba.
  await knex('homes').truncate() // Vacia la tabla homes
  await knex('homes').insert([ // Inserta estos parametros .Json
    {
      house_id: 1,
      title: 'Cozy Cottage',
